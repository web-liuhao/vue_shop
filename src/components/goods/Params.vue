    ...
    <el-card>
      ...
      <el-row class="cat_opt">
        <el-col>
          <span>选择商品分类：</span>
          <!-- 选择商品分类的级联选择框 -->
          <el-cascader v-model="selectedCateKeys" :options="cateList" :props="caterProps" @change="handleChange" clearable></el-cascader>
        </el-col>
      </el-row>
          ...
          <el-table :data="manyTableData" border stripe>
            ...
            <el-table-column type="expand">
              <template v-slot="scope">
                ...
                <!-- 输入文本框 -->
                <!-- keyup事件触发后，blur同样会被触发，造成两次提交,使用keyup事件触发blur事件 -->
                <el-input class="input-new-tag" v-if="scope.row.inputVisible" v-model="scope.row.inputValue" ref="saveTagInput" size="small" @keyup.enter.native="$event.target.blur" @blur="handleInputConfirm(scope.row)">
                </el-input>
                <!-- 添加按钮 -->
